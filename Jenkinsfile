pipeline {
    ...
    stages {
       stage('CleanWorkspace') {
        ...
        stage('Coverity Scan') {
            steps {
                withCoverityEnvironment(coverityInstanceUrl: 'https://mzm-XPS-13-9380:8443', createMissingProjectsAndStreams: true, projectName: 'develop_mzm_project1', streamName: 'develop_mzm_project1_stream', viewName: 'Outstanding Issues') {
    sh "echo $COV_STREAM"
