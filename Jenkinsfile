pipeline {
    ...
    coverityIssueCheck coverityInstanceUrl: 'https://mzm-XPS-13-9380:8443/', user: 'admin' , password: 'Coverity@2023', projectName: 'develop_mzm_project2', viewName: 'High Impact Outstanding' 
}
            }
        }
        }
