pipeline {
    ...
    //sh "cov-commit-defects --dir data --url https://mzm-XPS-13-9380:8443/ --stream develop_mzm_project3_stream --user admin --password Coverity@2023"
    sh "cov-commit-defects --dir /var/lib/jenkins/workspace/coverity_job/idir --stream develop_mzm_project3_stream --user admin --password Coverity@2023 --url https://mzm-XPS-13-9380:8443/"                
    coverityIssueCheck coverityInstanceUrl: 'https://mzm-XPS-13-9380:8443', markUnstable: true, projectName: 'develop_mzm_project3', viewName: 'Outstanding Issues'
}
            }
        }
        }
